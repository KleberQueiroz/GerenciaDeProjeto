...
UC16 - Mostrar Locais de Alimentação
...
<p align ="justify">Este caso de uso é responsável por mostrar ao usuário dados sobre os locais de alimentação.    UC20 - Mostrar Informações da Sala
